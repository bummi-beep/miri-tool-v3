...
// GCC가 const 구조체 배열 초기화 시 뒤쪽 필드를 0으로 채우더라도
// ESP-IDF의 컴파일 옵션에서 -Wmissing-field-initializers 경고가 발생하므로
// 이 파일 안에서만 경고를 끕니다.
...
const partinfo_t
        partDef[] =
        {
            ...
            // LPC43XX
            {{0xA001C830, ~0}, ~0, "LPC4357", 30, sectorMapLpc43x7, 2, 136 * 1024, 1024, 0x10000300, TERM_CRLF | UUENCODE},
